...
(function () {
  ...
  function show() {
    ...
    el.innerHTML =
      ...
      '<p class="subtle">Tasks, workouts, food, and study plans — one place,<br>scored on a simple idea: get 1% better on the days you show up.<br>Everything stays on this device — no account, nothing uploaded.</p>' +
      "</div>" +
      ...
      '<p>Plain words for everything: to-dos and projects with a clear next step, workout and food logging, habits you tap to check off, and what you\'re learning. The dashboard scores your day automatically.</p>' +
      ...
      "<p>Everything on the left with ops vocabulary, plus a homelab tracker (VMs, network zones, firewall rules) — loaded with demo data so every screen shows itself working.</p>" +
