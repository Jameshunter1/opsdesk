...
(function () {
  ...
  function show() {
    ...
    el.innerHTML =
      ...
      '<p class="subtle">One place for your money, to-dos, job hunt, and learning.<br>Everything stays on this device — no account, nothing uploaded.</p>' +
      "</div>" +
      ...
      '<p>Track spending in plain words ("I spent money", "I got paid"), keep a to-do list, follow job applications, and log what you\'re learning.</p>' +
      ...
      "<p>Everything above, plus a homelab tracker (VMs, network zones, firewall rules), a ticket system with a knowledge base, and double-entry books — loaded with a demo lab to explore.</p>" +
